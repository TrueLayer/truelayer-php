...
- Sub-merchant support for payments and payouts
- Ultimate counterparty information for business clients and business divisions
- Client factory methods for sub-merchant builders (`ultimateCounterparty()`, `paymentSubMerchants()`, `payoutSubMerchants()`)
- Comprehensive acceptance and integration tests for sub-merchant functionality
- Fluent API support for sub-merchant configuration
