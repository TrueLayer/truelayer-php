...
class WebhookPayload
{
    ...
    public static function payoutExecutedExternalAccount(): string
    {
        return '{
          "type": "payout_executed",
          "event_version": 1,
    ...
    public static function payoutFailedExternalAccount(): string
    {
        return '{
          "type": "payout_failed",
          "event_version": 1,
    ...
    public static function payoutUnknownBeneficiary(): string
    {
        return '{
          "type": "payout_failed",
          "event_version": 1,
